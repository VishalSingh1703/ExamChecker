...
type View = 'login' | 'signup' | 'forgot' | 'verify-sent' | 'reset-sent';
  ...
  if (view === 'verify-sent') {
    return (
      <Screen>
        ...
        <p className="text-sm font-medium text-gray-800 dark:text-gray-200 text-center mb-6 break-all">{email}</p>
